...
| Source-bound production model reconstruction | Complete | content-addressed model/dataset/Phase 4/split/Optuna lineage; independent gate replay, training-contract validation, and exact booster/evidence refit |
